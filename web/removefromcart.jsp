...
//            <!--id,	name,	password,	email,	role.-->
        ...
        <%
            ...
            co = DriverManager.getConnection(url, dbusername, dbpassword);
                ...
                String query1 = "SELECT * FROM CartDetails WHERE cartid ="+cartid+" AND prodId ="+prodid;
                System.out.println(query1);
                ResultSet rsa = s.executeQuery(query1);
            if(rsa.next()){
                
              
                   Statement   sa = co.createStatement();
                String querya = "DELETE FROM CartDetails WHERE cartid ="+cartid+" AND prodId ="+prodid;
                System.out.println(querya);
                sa.executeUpdate(querya);
                }
                co.close();
