...
<!--            - id,	catId,	name,	brand,	desc,	image,	price.-->
          ...
          <%  
              ...
              conn = DriverManager.getConnection(url, dbusername, dbpassword);
                st = conn.createStatement();
                String query1 = "SELECT * FROM BestSelling LEFT JOIN ProductMaster ON ProductMaster.id = BestSelling.prodId";
          ...
          %>
                 <div class="deleteitems" align="center">
                  ...
                  <div class="dropdown">       Product name: <%=rsa.getString("name")%><br>
                       ...
                       Price<%=rsa.getString("price")%><br>
                       <br>
                      <a class="homebutton" href="addtocart.jsp?prodid=<%=rsa.getInt("prodId")%>"><b>Add to cart</b></a>
                     </div>
