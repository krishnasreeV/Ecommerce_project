...
<html>
    ...
    <body>
        ...
        <%}else{
        %>    <div class="heading" >
        <h1 align="center">Welcome to Myntra <%=username%> </h1><br>
        </div>
...
//            <!--id,	name,	password,	email,	role.-->
        ...
        <div class="forms" align='center'>
            <form method="post" action="Addbestselling_1.jsp">
                <select name="product">
                    <option>Select a product to add to bestselling category</option>
                     <% while(rs.next()){ %>
